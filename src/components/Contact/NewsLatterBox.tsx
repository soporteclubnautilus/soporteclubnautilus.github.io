...
const NewsLatterBox = () => {
  ...
  useEffect(() => {
    // Esto asegura que el código se ejecute solo en el navegador
    setIsClient(true);
  }, []);
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-5 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        <a 
      ...
      <h3 className="mb-4 text-2xl leading-tight font-bold text-black dark:text-white">
        Telefono celular  - complejo
      </h3>
      <p className="border-body-color/25 text-body-color border-b pb-5 text-base leading-relaxed dark:border-white/25">
        <a 
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#7193C1" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
